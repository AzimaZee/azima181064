"""
Django settings for project_azima project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-^x%h713!9^yi6e#xvaimxb5r61mx%zy7s1d)8#(b!42t%q7(ky')
...
ROOT_URLCONF = 'project_azima.urls'
...
WSGI_APPLICATION = 'project_azima.wsgi.application'
